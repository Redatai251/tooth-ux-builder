    ...
    <footer className="px-3 sm:px-6 pb-6 pt-16 bg-gradient-to-b from-brand-soft/40 to-secondary/40">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-2 text-xs text-muted-foreground px-2">
          <p>Copyright © 2026 <span translate="no">Finan Speciality Dental Clinic</span>. All rights reserved.</p>
          <p>Website Developed By{" "}<a href="https://bloomuptech.com/" target="_blank" rel="noopener noreferrer" className="text-brand hover:underline" translate="no">BloomUp Technologies</a></p>
        </div>
      </div>
    </footer>
  );

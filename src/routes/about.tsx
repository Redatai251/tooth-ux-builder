  ...
  head: () => ({
    meta: [
      { title: "About Dr. Selamawit Abraham Mesfin — Finan Dental" },
      {
        name: "description",
        content:
          "Meet Dr. Selamawit Abraham Mesfin, founder of Finan Speciality Dental Clinic — 10+ years of experience in modern dentistry in Addis Ababa.",
      },
    ...
    <Layout>
      ...
      <section className="relative overflow-hidden bg-brand-dark text-white">
        <div
          ...
          style={{
            background:
              "radial-gradient(60% 50% at 50% 0%, rgba(110,231,255,0.25) 0%, transparent 70%)",
          }}
        />
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 pt-36 sm:pt-44 pb-14 sm:pb-20 grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            ...
            <p className="mt-5 text-white/75 max-w-xl">
              Founded by Dr. Selamawit Abraham Mesfin (HO, MPH, DDM), Finan Speciality Dental Clinic
              delivers modern, gentle and affordable dental care — built around comfort and
              long-term oral health.
            </p>
            <div className="mt-7 flex flex-wrap gap-3">
              <Link
                to="/book"
                className="inline-flex items-center gap-2 rounded-full bg-brand text-white px-6 py-3 text-sm hover:bg-brand-glow hover:text-brand-dark"
              >
          ...
          <div className="rounded-[2rem] overflow-hidden bg-white/5 ring-1 ring-white/15 shadow-2xl aspect-[4/5] max-w-md mx-auto lg:mx-0 w-full">
            <img
              src={doctor}
              alt="Dr. Selamawit Abraham Mesfin"
          ...
          {[
            {
              ...
              d: "A decade of clinical excellence and continuous training in modern dentistry.",
            },
            {
              icon: Users,
              t: "Specialist Team",
              d: "Specialists across orthodontics, surgery, pediatrics and cosmetic care.",
            },
            {
              icon: Heart,
              t: "Patient-First Care",
              d: "Every plan is personalized — we listen first, treat gently, and follow up.",
            },
          ].map((c) => (
      ...
      <section className="pb-20 bg-background">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 text-center">
          ...
          <p className="mt-5 text-muted-foreground">
            ...
            treatment options and pain-free procedures — so every visit feels easy and every patient
            leaves smiling.
          </p>
        </div>
      </section>
